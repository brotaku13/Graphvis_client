    ...
    if (index === step.INFO) {
      return (
        <div className="montserrat">
          ...
          <Button
            color="primary"
            disabled={!this.state.completedSteps.has(index)}
      ...
      return (
        <div className="montserrat">
          ...
          <Button
            color="primary"
            disabled={!this.state.completedSteps.has(step.CONTROL)}
            onClick={this.handleNext}
          >
            Next
          </Button>
      ...
      if (this.state.submission_status === 'error') {
        ...
        return (
          <Button color="primary" onClick={this.handleGoToGraph}>
            Go to Graph
          </Button>
        )
      }
